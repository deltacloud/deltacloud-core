...
#          nics = []
#          safely do
#            ec2.describe_network_interfaces.each do |nic|
#              nics << convert_nic(nics)
#            end
#          end
...
#            #attach it:
#            ec2.attach_network_interface({:nic_id => nic[:id], :instance_id => opts[:instance], :device_index => 0})
#            convert_nic(nic)
#          end
#        end
#
...
#sources_string.slice(0,sources_string.length-1)}"
        ...
        def convert_nic(nic, instance_id=nil)
          instance = instance_id || nic[:attachment][:instance_id]
          NetworkInterface.new({  :id => nic[:id],
                                  :name => nic[:id],
                                  :instance => instance,
